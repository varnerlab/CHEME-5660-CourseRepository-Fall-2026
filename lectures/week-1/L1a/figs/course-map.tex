...
\begin{tikzpicture}[
  ...
  \foreach \i/\x/\utitle in {%
      1/0/{Foundations and payments over time},
      2/4.35/{Stocks, uncertainty, and choosing a mix},
      3/8.70/{Investments whose value depends on stocks},
      4/13.05/{Models for financial decisions}}{%
    \node[unit] (u\i) at (\x,0)
  ...
  \foreach \i/\x/\cap in {%
      1/0/{compare dollars on different dates},
      2/4.35/{describe uncertainty},
      3/8.70/{find the value of one investment from another},
  ...
  \draw[vn brace] (-1.78,1.05) -- (14.83,1.05)
    ...
    {\bfseries given investment choices, uncertainty, and your priorities: what do you do?};
\end{tikzpicture}
\endgroup
