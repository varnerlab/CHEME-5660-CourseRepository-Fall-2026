...
\begin{tikzpicture}[
  ...
  \foreach \i/\x/\kind/\utitle in {%
      1/0/{Debt}/{Treasury securities},
      2/4.35/{Equity}/{Stocks and portfolios},
      3/8.70/{Derivatives}/{Options},
      4/13.05/{Decisions}/{Financial strategies}}{%
    \node[unit] (u\i) at (\x,0)
  ...
  \draw[vn timeline] (-1.95,-1.35) -- (15.6,-1.35) node[right,text=vnmuted] {weeks};
  ...
  \draw[vn brace] (-1.90,1.15) -- (14.95,1.15)
    node[midway,above=7pt,text=vnmuted]
