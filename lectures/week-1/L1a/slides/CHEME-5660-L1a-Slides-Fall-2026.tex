...
\begin{frame}{Gross Notional Value Is About 108 Times Premium Paid}
  ...
  \[
    ...
    \;\Big/\;
    \underbrace{\text{USD } 37\text{B}}_{\text{\footnotesize premium}}
    \;=\;
    \underbrace{108\times}_{\text{\footnotesize \$108 gross notional per \$1 paid}}
  \]

  \vspace{0.25em}
  Interestingly, about \hilite{USD 3T} of that value came from cash-settled S\&P 500 index options. For an option, gross notional divided by premium approximates exposure-based
...
\begin{frame}{Each Unit Connects Information, Choice, and Outcome}
  \vspace{0.1em}
  Each unit turns market information into a choice, then evaluates what that
  choice produces.
  ...
  \begin{tabular}{@{}llll@{}}
    \hline\\[-7pt]
    \parbox[t]{0.14\textwidth}{\raggedright\textbf{\ink{Unit}}} &
    \parbox[t]{0.24\textwidth}{\raggedright\textbf{\ink{What we observe}}} &
    \parbox[t]{0.24\textwidth}{\raggedright\textbf{\ink{What we choose}}} &
    \parbox[t]{0.25\textwidth}{\raggedright\textbf{\ink{What we evaluate}}}\\[3pt]
    \hline\\[-7pt]
    \parbox[t]{0.14\textwidth}{\raggedright\textbf{\hilite{Debt}}} &
    \parbox[t]{0.24\textwidth}{\raggedright rates and promised cash flows} &
    \parbox[t]{0.24\textwidth}{\raggedright security and maturity} &
    \parbox[t]{0.25\textwidth}{\raggedright price, yield, and rate risk}\\[5pt]
    \parbox[t]{0.14\textwidth}{\raggedright\textbf{\hilite{Equity}}} &
    \parbox[t]{0.24\textwidth}{\raggedright cash flows and growth} &
    \parbox[t]{0.24\textwidth}{\raggedright stock or portfolio} &
    \parbox[t]{0.25\textwidth}{\raggedright value, return, and risk}\\[5pt]
    \parbox[t]{0.14\textwidth}{\raggedright\textbf{\hilite{Derivatives}}} &
    \parbox[t]{0.24\textwidth}{\raggedright price and volatility} &
    \parbox[t]{0.24\textwidth}{\raggedright contract or hedge} &
    \parbox[t]{0.25\textwidth}{\raggedright payoff, exposure, and risk}\\[5pt]
    \parbox[t]{0.14\textwidth}{\raggedright\textbf{\hilite{Strategies}}} &
    \parbox[t]{0.24\textwidth}{\raggedright signals and constraints} &
    \parbox[t]{0.24\textwidth}{\raggedright allocation and trading rule} &
    \parbox[t]{0.25\textwidth}{\raggedright performance and robustness}\\[2pt]
    \hline
  \end{tabular}
  \end{center}

  \vspace{0.25em}
  \ink{Unit 4 combines the asset-level choices from Units 1 to 3 into a strategy.}
\end{frame}

% ==== ladder ====
\begin{frame}{Valuation Is the First Test, Not the Last}
  \vspace{0.05em}
  {\large Units 1 to 3 build models of prices and payoffs. Unit 4 asks
  whether a strategy survives data, time, and execution.}
  ...
  \vspace{0.25em}
  {\large\ink{The goal is to find failures before real money is at risk.}}
