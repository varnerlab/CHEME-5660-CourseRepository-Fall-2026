...
\begin{frame}{Gross Notional Value Is About 108 Times Premium Paid}
  ...
  Gross notional is not cash turnover. About \hilite{USD 3T} came from
  cash-settled S\&P 500 index options.

  \vspace{0.35em}
  For an option, gross notional divided by premium approximates exposure-based
  leverage when $|\delta| \approx 1$. Otherwise, delta determines exposure.

  \slidenote{Contract size:}{standard equity options generally represent 100 shares; index options use a multiplier.}
\end{frame}
