...
\begin{frame}{Gross Notional Value Is About 108 Times Premium Paid}
  ...
  \vspace{0.05em}
  This ratio compares gross notional value with cash paid for the options.
  It does not measure market exposure or leverage. The \hilite{USD 4 trillion}
  is not cash turnover; many contracts are cash-settled, expire unused, or
  close before exercise.

  \slidenote{Careful:}{108 times is gross notional value divided by premium paid, not exposure or leverage. About USD 3.0T comes from cash-settled S\&P 500 index options, so no shares are transferred.}
\end{frame}
