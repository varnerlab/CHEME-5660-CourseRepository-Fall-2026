...
\begin{frame}{How This Course Runs}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.305\textwidth}
      \eyebrow{Materials}
      \vspace{0.25em}
      {\small Download each weeks materials from the repository releases page, or clone
    ...
    \begin{column}{0.305\textwidth}
      \eyebrow{Questions}
      \vspace{0.25em}
      {\small Ask on the course discussion board (EdDiscussion) rather than by email, so each
