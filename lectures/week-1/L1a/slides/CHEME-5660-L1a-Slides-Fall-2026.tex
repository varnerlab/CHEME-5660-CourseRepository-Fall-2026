...
\begin{frame}{How This Course Runs}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.305\textwidth}
      \eyebrow{Materials}
      \vspace{0.25em}
      {\small Download each week from the repository releases page, or clone
    ...
    \begin{column}{0.305\textwidth}
      ...
      with the Julia extension. Set these up once.}
    \end{column}
    \begin{column}{0.305\textwidth}
      \eyebrow{Questions}
      \vspace{0.25em}
      {\small Ask on the course discussion board rather than by email, so each
      answer reaches everyone with the same question.}
    \end{column}
  \end{columns}
...
\begin{frame}{The Course Moves from Valuing Assets to Making Decisions}
  ...
  \vspace{0.05em}
  \begin{center}
    \resizebox{0.95\textwidth}{!}{\input{../figs/course-map.tex}}
  \end{center}
...
\begin{frame}{Strategy Validation Uses Four Levels of Evidence}
  \vspace{0.05em}
  Units 1 to 3 build models of prices and payoffs. Unit 4 evaluates strategies
  using past data, current data, and actual trades.

  \vspace{0.15em}
  \begin{center}
    \makebox[\textwidth][l]{%
      \hspace*{-0.04\textwidth}% optical centering: rung labels contain left-side padding
      \resizebox{0.96\textwidth}{!}{\input{../figs/validation-ladder.tex}}}
  \end{center}

  \vspace{0.1em}
  \textbf{Each row includes the evidence below it and adds one new source.}
...
\begin{frame}{Five Investments Have Different Payment Schedules}
  ...
  \begin{tabular}{@{}l@{\hspace{1.2em}}l@{}}
    ...
    \textbf{\hilite{C}} & \$264 every six months for \textbf{30} years, then \$10{,}000\\[2pt]
    \textbf{\hilite{D}} & \$271 every six months for 10 years, then \$10{,}000\\[2pt]
    \textbf{\hilite{E}} & \$121 every six months for 10 years, plus an inflation\\
...
\begin{frame}{Compare the Amount, Timing, and Uncertainty of Payments}
  ...
  \begin{itemize}\setlength{\itemsep}{0.35em}
    \item \hilite{\textbf{C}}\quad\textbf{\ink{What if you need the money before year 30?}} Selling early
      means accepting the market price then, and that price changes with
      interest rates. \dimmed{Week 2.}
    \item \hilite{\textbf{D}}\quad\textbf{\ink{Why does it pay more?}} Its rate is 5.42\%, versus 4.71\%
    ...
    \item \hilite{\textbf{E}}\quad\textbf{\ink{What does inflation protection change?}} Its payments rise
...
\begin{frame}{A Bank Can Fail Even When Its Securities Do Not Default}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.69\textwidth}
      A bank with roughly this much in assets failed in two days. Its portfolio
      included one of the five kinds of promises on your list.

      \vspace{0.5em}
      {\large\vnmedium\ink{Which one, and why?}}
    \end{column}
  \end{columns}
