...
\begin{frame}{Markets Connect You, Cornell, and Companies}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.285\textwidth}
      ...
      \vspace{0.3em}
      {\small How the account is invested determines the risk and reward trade-off.}
...
\begin{frame}{U.S. Markets Move About \$1.85 Trillion a Day}
  ...
  \vspace{-0.15em}
  On the same daily basis: US Markets move \hilite{\$1.85T} versus \hilite{\$3.36B} in global Biopharma and Batteries, about
  \hilite{550 times larger}. Massive financial flows every day.
...
\begin{frame}{Five Investments Have Different Payment Schedules}
  ...
  today. The are five different schedules of payments, each with a different amount, timing and uncertainty.
...
\begin{frame}[t]{Summary}
  ...
  \begin{itemize}\setlength{\itemsep}{0.35em}
    ...
    \item \textbf{\ink{Amount and timing are not enough.}} Interest-rate,
      credit, liquidity, and inflation risk can change which payment schedule
      is preferable.
  \end{itemize}
