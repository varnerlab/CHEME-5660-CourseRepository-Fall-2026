...
% other: the point is the scale comparison on one date.
\begin{frame}[t]{Federal Deficits Require Treasury Borrowing}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.43\textwidth}
      {\small\textbf{FEDERAL DEBT, AUGUST 20, 2026}}

      \vspace{0.15em}
      {\fontsize{34}{36}\selectfont\bfseries\hilite{\$40.03T}\par}
      {\small total federal debt outstanding}
    ...
    \begin{column}{0.53\textwidth}
      {\small\textbf{AUGUST 20 LIQUIDITY-SUPPORT BUYBACK}}
      ...
      \vspace{0.25em}
      {\small The buyback retired portions of three older issues. It equaled
      \hilite{0.006\%} of publicly held debt and supported market liquidity.}
    \end{column}
  \end{columns}

  \vspace{0.1em}
  {\large\textbf{Why elected officials care:}} continuing deficits require
  repeated borrowing from investors at market interest rates.

  \slidenote{Sources:}{\href{https://fiscaldata.treasury.gov/datasets/debt-to-the-penny/}{Debt to the Penny}; \href{https://www.treasurydirect.gov/instit/annceresult/press/preanre/2026/BBR_20260820174000.pdf}{August 20 buyback results}; \href{https://www.treasurydirect.gov/help-center/faqs/buyback-faqs/}{Buyback FAQs}}
\end{frame}
...
\begin{frame}{Every Unit Turns Information into a Choice}
  \vspace{0.1em}
  The asset changes, but the questions stay the same.

  \vspace{0.5em}
  \begin{center}\footnotesize
  \begin{tabular}{@{}l@{\hspace{2.0em}}l@{\hspace{2.0em}}l@{\hspace{2.0em}}l@{}}
    \hline\\[-7pt]
    \textbf{\ink{Unit}} & \textbf{\ink{Observe}} &
    \textbf{\ink{Choose}} & \textbf{\ink{Evaluate}}\\[4pt]
    \hline\\[-7pt]
    \textbf{\hilite{Debt}} & rates and payments & bond and maturity &
    price and rate risk\\[8pt]
    \textbf{\hilite{Equity}} & cash flows and growth & stock or portfolio &
    value and risk\\[8pt]
    \textbf{\hilite{Derivatives}} & price and volatility & contract and position &
    payoff and risk\\[8pt]
    \textbf{\hilite{Strategies}} & signals and limits & allocation rule &
    performance over time\\[3pt]
    \hline
  \end{tabular}
  \end{center}

  \vspace{0.45em}
  \ink{Unit 4 combines the first three units into a strategy.}
\end{frame}

% ==== ladder ====
\begin{frame}{Strategy Validation Uses Four Levels of Evidence}
  \vspace{0.05em}
  {\large Units 1 to 3 build models of prices and payoffs. Unit 4 evaluates
  strategies using past data, current data, and actual trades.}
  ...
  \vspace{0.25em}
  {\large Each row includes the evidence in the rows below it and adds one
  new source.}
...
\begin{frame}{Five Investments Have Different Payment Schedules}
  \vspace{0.1em}
  Suppose you could buy each set of future payments for \hilite{\$10{,}000}
  today. Start with the information shown: compare the amount and timing of the
  payments.
  ...
  \vspace{0.5em}
  {\large\ink{\textbf{Which promise would you choose?}} Let's brainstorm and vote.}
...
\begin{frame}{Compare the Amount, Timing, and Uncertainty of Payments}
  \vspace{0.15em}
  The schedules show amount and timing. The following questions identify three
  ...
  \vspace{0.35em}
  \ink{Amount and timing are not sufficient without these sources of
  uncertainty.}
\end{frame}
...
\begin{frame}[t]{Summary}
  ...
  \vspace{0.2em}
  \begin{itemize}\setlength{\itemsep}{0.35em}
    \item \textbf{\ink{Markets connect investors, companies, and governments.}}
      Cornell invests its endowment; companies issue shares; Treasury borrows
