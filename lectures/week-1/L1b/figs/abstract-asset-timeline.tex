...
%   ../docs/Style-Specimen.tex          (typeset directly into the L1b notes)
%   Fig-L1b-AbstractAsset-Timeline.tex  (standalone -> PDF -> SVG for notebooks)
% Editing this file updates both. Rebuild the SVG with `make` in this directory.
%
