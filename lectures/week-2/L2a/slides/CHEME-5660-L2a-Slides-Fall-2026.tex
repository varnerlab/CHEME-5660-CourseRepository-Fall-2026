...
\begin{frame}{Objectives for Today}
  ...
  \begin{itemize}\setlength{\itemsep}{0.5em}
    ...
    \item \hilite{Evaluate the risk-free label}: explain why Treasuries are a
      common benchmark and why low default risk does not remove interest-rate
      risk.
  \end{itemize}
  \vspace{-0.4em}
...
\begin{frame}{Case Study: 2008 Financial Crisis}
  \vspace{0.5em}
