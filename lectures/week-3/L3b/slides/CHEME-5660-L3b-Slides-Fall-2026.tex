...
\begin{frame}{Optional Advanced Material}
  \vspace{0.3em}
  \textbf{\ink{Recombination and computational cost}}\quad{\footnotesize\dimmed{advanced/recombination/}}

  Compare the full binary path tree with its recombined lattice. Verify that
  asymmetric factors still recombine, count the saved nodes, and identify when
  time-dependent move factors prevent paths from merging.

  \vspace{0.8em}
  \textbf{\ink{Bootstrap calibration uncertainty}}\quad{\footnotesize\dimmed{advanced/calibration/}}

  Resample historical growth rates, re-estimate $(u,d,p)$, and carry the
  resulting uncertainty into terminal-price and probability-of-profit
  calculations. Compare independent, block-bootstrap, and holdout results.

  \slidenote{Notebooks:}{\href{https://github.com/varnerlab/CHEME-5660-CourseRepository-Fall-2026/tree/main/lectures/week-3/L3b/advanced}{lectures/week-3/L3b/advanced}, also linked from the Optional Advanced Material section of the lecture notebook.}
\end{frame}
