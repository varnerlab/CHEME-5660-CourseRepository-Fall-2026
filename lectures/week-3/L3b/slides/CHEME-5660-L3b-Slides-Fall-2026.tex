...
\begin{frame}{Optional Advanced Material}
  \vspace{0.3em}
  \textbf{\ink{Recombination and computational cost}}
  ...
  \vspace{0.8em}
  \textbf{\ink{Bootstrap calibration uncertainty}}
  ...
  \slidenote{Notebooks:}{\href{https://github.com/varnerlab/CHEME-5660-CourseRepository-Fall-2026/tree/main/lectures/week-3/L3b/advanced}{lectures/week-3/L3b/advanced}}
\end{frame}
