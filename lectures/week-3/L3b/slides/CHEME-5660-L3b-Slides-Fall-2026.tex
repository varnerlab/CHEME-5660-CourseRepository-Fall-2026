...
\begin{frame}{Optional Advanced Material}
  ...
  its recombined lattice and shows when time-dependent moves stop recombining;
  the second bootstraps historical growth rates to measure the uncertainty in
  $(u,d,p)$ and in the forecasts computed from them.
