...
\textbf{\ink{Lecture:}}
  ...
  We compare its prediction bands with observed prices and measure coverage in 2025.
...
\begin{frame}{Review: The GBM Trade Rule}
...
\begin{frame}{Review: The Target Probability}
  ...
  Here, $\mu_g$ is the mean growth rate, $\sigma>0$ is the volatility parameter, and
...
\begin{frame}{Multiple Asset Geometric Brownian Motion}
  ...
  Growth-rate covariance has units of year$^{-2}$; multiplying by $\Delta t$
...
\begin{frame}{From Prices to Growth Rates}
  ...
  $C_{ii}=\sigma_i^2$. Growth rates and their means have units of year$^{-1}$.
\end{frame}
...
\begin{frame}{Optional Advanced Material}
  ...
  \vspace{0.8em}
  \dimmed{Optional; neither notebook is a prerequisite for L6a.}
\end{frame}
