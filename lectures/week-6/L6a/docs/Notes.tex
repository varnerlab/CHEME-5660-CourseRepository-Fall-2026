...
\notebooklink
  ...
  {Compare empirical-residual and Gaussian parametric bootstrap intervals with ridge-sandwich standard errors, then audit fitted residuals for heavy tails and volatility memory.}
